...
**WskazÛwka:** If at first you don't succeed, try, try again. And again. And again.
...
**WskazÛwka:** Remember the flag format is picoCTF{XXXX}
...
**WskazÛwka:** Linux for [Beginners](https://maker.pro/education/basic-linux-commands-for-beginners)
...
**WskazÛwka:** Client Side really is a bad way to do it.

**Rozwiπzanie:** èrÛd≥o strony
...
**WskazÛwka:** Hmm it doesn't seem to check anyone's password, except for admins?
How does check the admin's password?

**Rozwiπzanie:** Ingerencja w cookisy [python](/logon/run.py)
...
**WskazÛwka:** Maybe try writing a python script?

**Rozwiπzanie:** Screen przedstawia rÍczne rozwiπzanie. Mam dodatkowo skrypt, jednak kod nie dzia≥a pomimo tego, øe jest prawid≥owy.
...
**WskazÛwka:** How do you inspect a website's code on a browser?
